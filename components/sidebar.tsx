...
const SideBar = ({
  ...
  return <>
    <div className="space-y-4 py-4 flex flex-col h-full bg-white/100 border ">
        ...
        <div className="space-y-1">
          {
            routes.map((route) => (
              <Link href={route.href}
                key={route.href}
                className={cn("text-sm group flex p-3 w-full justify-start font-medium cursor-pointer hover:text-gray-900 rounded-lg transition hover:bg-white/10",
